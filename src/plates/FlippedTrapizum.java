...
public class FlippedTrapizum extends Trapizum {

	private int width, height;
	private PlateStates plateState;
	private Color color;

	public FlippedTrapizum(int width, int height, Color color) {
	...
	public FlippedTrapizum(FlippedTrapizum clone) {
	...
	public void draw(Graphics2D g) {
		...
		ypoints[0] = ypoints[1] = center.y;
		ypoints[2] = ypoints[3] = center.y - height;
		// trapizium shape
